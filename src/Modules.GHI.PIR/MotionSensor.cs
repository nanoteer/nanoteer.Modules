...
namespace Nanoteer.Modules.GHI
{
    ...
    {
        private InterruptInput motionDetect;
        ...
        public MotionSensor(int socketNumber)
        {
            ...
            motionDetect.Interrupt += input_Interrupt;
        }

        private void input_Interrupt(InterruptInput interrupt, bool state)
        {
